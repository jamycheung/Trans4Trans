...
########################## trans4trans config #####################################
cfg.MODEL.TRANS4TRANS.embed_dim = 256
cfg.MODEL.TRANS4TRANS.depth = 4
cfg.MODEL.TRANS4TRANS.num_heads = 8
cfg.MODEL.TRANS4TRANS.mlp_ratio = 3.
cfg.MODEL.TRANS4TRANS.hid_dim = 64
